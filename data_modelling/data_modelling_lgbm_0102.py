...
'acoustic_vector_4','acoustic_vector_5','acoustic_vector_6','acoustic_vector_7','skip_2_avg']
...
pathlib.Path('output_1224_v5').mkdir(parents=True, exist_ok=True)
...
for i in tqdm(range(start-1,end,1)):
    ...
    '''save file'''
    output_path = 'output_1224_v5/'+date_of_name[i]+'.txt'
...
out_path = glob.glob('output_1224_v5/*')
out_path.sort()
...
output_file = open('output_1224_v5/submission.txt', 'w')
